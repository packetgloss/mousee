...
directly as a GUI-subsystem process: Windows does not create a console window
at all. An interactive release launch still creates or attaches a console for
the QR and prompts.
